/*
  ...
  1. New Columns
    - `custom_class_data` (jsonb) - Stores custom class configuration including:
      ...
      - resources: Array of custom class resources with:
        - id, name, maxValue, color, icon, shortRest, longRest
      - abilities: Array of class abilities with:
        - id, name, description, level

  2. Purpose
    - Allow players to create fully customizable classes
    - Store custom class resources and abilities per level
    - Enable in-game customization of class features

  3. Notes
    - The column is nullable to maintain compatibility with standard classes
    - Data is stored in the stats.creator_meta for consistency with custom_race
*/
