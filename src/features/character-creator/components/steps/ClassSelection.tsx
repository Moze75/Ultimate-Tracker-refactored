...
import { Sword, Heart, Shield, Zap, BookOpen, CheckSquare, Square, Package, Wrench, Star, Sparkles, Settings, Edit2, Trash2 } from 'lucide-react';
import { deleteUserCustomClass } from '../../../../services/customTemplatesService';
