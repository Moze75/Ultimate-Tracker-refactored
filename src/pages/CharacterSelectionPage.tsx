...
// En haut de ton composant CharacterSelectionPage
...
}, [loading, players, currentSubscription]);
...
<div
  key={player.id}
  className="frame-card--light frame-card--tex2 frame-card--no-frame p-0 group"
>
                    <button
                      onMouseDown={(e) => {
                        e.preventDefault();
                    ...
                    <div
className={`px-6 pb-6 pt-0 cursor-pointer hover:scale-[1.02] transition-all duration-200 relative z-10 ${
