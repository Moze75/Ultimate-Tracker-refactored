...
<div className="col-span-4">
  ...
  <div className="col-span-4 flex">
    ...
    <div className="bg-gray-800/70 rounded-lg border border-gray-700 backdrop-blur-sm p-4 w-full max-h-[800px]">
  ...
  <div className="col-span-8 flex">
    <div className="bg-gray-800/70 rounded-lg border border-gray-700 backdrop-blur-sm p-4 w-full flex flex-col max-h-[800px]">
      <TabbedPanel
        player={player}
        inventory={inventory}
