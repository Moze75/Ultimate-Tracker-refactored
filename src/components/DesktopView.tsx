      ...
      <div className="fixed inset-0 z-10 flex flex-col">
        ...
        >
          <div className="max-w-[1280px] mx-auto space-y-4">
            ...
            <div className="grid grid-cols-12 gap-4">
              <div className="col-span-4">
                <div className="bg-gray-800/70 rounded-lg border border-gray-700 backdrop-blur-sm p-4 w-full overflow-y-auto" style={{ maxHeight: '800px' }}>
              ...
              <div className="col-span-8">
                <div className="bg-gray-800/70 rounded-lg border border-gray-700 backdrop-blur-sm p-4 w-full flex flex-col overflow-hidden" style={{ maxHeight: '800px' }}>
                  <TabbedPanel
                    player={player}
                    inventory={inventory}
