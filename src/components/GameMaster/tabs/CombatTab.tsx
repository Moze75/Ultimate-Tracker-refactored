  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
      {/* LEFT: Search / Bestiary - Desktop only */}
               <div className="hidden lg:block space-y-4 bestiary-panel bestiary-panel--no-frame rounded-xl lg:mx-[30px] lg:mt-[30px] p-4">
        <div className="flex gap-2 border-b border-gray-700 pb-2">
          ...
          >
            <Search size={12} className="inline mr-1" /> Ajouter monstres
          </button>
          <button
      ...
      <div className="space-y-4 relative">
        ...
        <div className="lg:hidden space-y-3">
          ...
          {mobileSearchOpen && (
            <div
                       className="frame-card--light frame-card--no-frame bestiary-overlay-mobile flex flex-col p-4"
              style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, zIndex: 50, overflow: 'hidden', touchAction: 'none', border: 'none', borderRadius: 0, boxShadow: 'none', paddingTop: 0 }}
