...
<div className="flex flex-col h-full bg-gray-900/70 backdrop-blur-md border-l border-white/10 overflow-hidden shadow-2xl relative" style={{ width: sidebarWidth }}>
      ...
      >
        ...
        {/* Pastille 3 points — centrée grâce au flex du parent */}
        <div className="flex flex-col items-center justify-center gap-[3px] px-0.5 py-2 rounded-full bg-gray-700/80 group-hover:bg-amber-500/90 transition-colors shadow-md">
