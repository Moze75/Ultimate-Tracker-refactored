  ...
  const modalContent = (
    ...
    >
      ...
      >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                ...
                <div className="md:col-span-2">
                  ...
                  <p className="text-[10px] text-gray-500 mt-1">
                    Finesse/Légère/Lancer/Polyvalente influencent STR/DEX en mêlée.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="ex: Corps à corps, 6 m..."
                  />
                </div>
                <div>
          ...
          {type === 'armor' && (
            <div className="space-y-3 border-t border-gray-700 pt-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                <div>
                  <label className="block text-xs text-gray-400 mb-1">Base CA</label>
                  <input
                    type="number"
                    className="input-dark w-full px-3 py-2 rounded-md"
                    value={armBase}
                    onChange={(e) => setArmBase(parseInt(e.target.value) || 10)}
                  />
                </div>
                <div className="flex items-center gap-2">
                  <input
                    ...
                    type="checkbox"
                    checked={armAddDex}
                    onChange={(e) => setArmAddDex(e.target.checked)}
                  />
                  <label htmlFor="addDex" className="text-sm text-gray-300">
                    + Mod DEX
                  </label>
                </div>
                <div>
                  <label className="block text-xs text-gray-400 mb-1">Cap DEX (vide = illimité)</label>
                  <input
                    type="number"
                    className="input-dark w-full px-3 py-2 rounded-md"
                    value={armDexCap}
        ...
        {/* Footer */}
        <div className="flex items-center justify-end gap-3 px-5 py-4 border-t border-gray-700/30 bg-black/10 flex-shrink-0">
          <button onClick={onClose} className="btn-secondary px-4 py-2 rounded-lg">
            Annuler
          </button>
          <button onClick={add} className="btn-primary px-4 py-2 rounded-lg">
            Ajouter
          </button>
        </div>
      </div>
