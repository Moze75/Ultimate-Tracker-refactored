    ...
    <div className="min-h-screen flex items-center justify-center p-4">
        ...
        {/* Header */}
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 mt-1">Version 2.3.1</p>
          </div>
          <button
            onClick={onClose}
...
function BackgroundTab({
  ...
  const backgroundImages = [ 
    ...
    { url: 'https://pub-34f7ade8969e4687945b58e1d1b80dd8.r2.dev/static/backscreen/forest.png', name: 'forest', type: 'image' as const },
