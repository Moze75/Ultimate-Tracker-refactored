...
import { getDiceBoxInstance, updateDiceBoxSettings, clearDiceBoxDice } from '../utils/diceBoxInstance';
...
export function DiceBox3D({ isOpen, onClose, rollData, settings }: DiceBox3DProps) {
  ...
  // ✅ Lancer les dés (MODIFIÉ - avec clearDice)
  useEffect(() => {
    ...
    // ✅ IMPORTANT : Nettoyer les dés précédents AVANT le nouveau lancer
    // C'est ce que fait le code original dans rollDice() ligne 861
    clearDiceBoxDice();
    ...
    // ✅ Lancement des dés avec un délai pour laisser clearDice() finir
  ...
  const handleOverlayClick = useCallback(() => {
    if (isRolling) {
      ...
      // ✅ Nettoyer aussi lors de l'interruption
      clearDiceBoxDice();
